...
class TestCase(DjangoTestCase):
    ...
    def setUp(self):
        global dbconn
        dbconn[settings.ITEMS_COLL].remove()
        dbconn[settings.IDS_COLL].remove()
...
class ItemListControllerTest(TestCase):
    ...
    def test_post_repeated_name(self):
        '''ItemListControllerTest test POST Item with repeated name
        '''
        item = {"name": "Super item 12345", "description": "This is the most amazing super item 12345",
                "category": "Strange items", "price": 17.99, "stock": 3
                }
